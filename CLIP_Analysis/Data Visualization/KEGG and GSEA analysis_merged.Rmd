...
protein_quant <- read_csv("~/OneDrive - Harvard University/Haigis Lab/Projects/Halo-Ago2/Halo-Ago-KRas/Raw Data/Proteomics data/scraped colon/2015-03_HaigisMouseColon8plex_Prot.csv")
...
protein_DGE$s2n <- apply(protein_quant,1,s2n,cond_1 = c(9:12),cond_2 = c(5:8))
```
...
dev.off()
```
![GSEA](/Users/mizuhi/OneDrive - Harvard University/Haigis Lab/Projects/Halo-Ago2/Halo-Ago-KRas/Raw Data/HEAP-CLIP/HEAP_12232019/Analysis/CLIP_Analysis/Data Visualization/GSEA Analysis/GSEA_HEAP-CLIP_merged_peaks.png)
