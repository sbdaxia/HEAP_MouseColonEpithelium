---
title: "RNA_half_life_CDF using merged peaks"
author: "Bing Shui"
date: "`r Sys.Date()`"
output: 
    html_document:
...
Set up the function
```{r}
dir.create("PDF_figure/RNA_half_life_merged", showWarnings = FALSE)
...
pdf("PDF_figure/RNA_half_life_merged/CDF_RNA_halflife_human.pdf",
    height = 4,
    width = 6)
plotCDF.ggplot(peak.DGE,
               list(short_peaks, long_peaks),
...
pdf("PDF_figure/RNA_half_life_merged/CDF_RNA_halflife_mouse.pdf",
    height = 4,
    width = 6)
plotCDF.ggplot(peak.DGE,
               list(short_peaks, long_peaks),
